...
export const LogoIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4.653 3.516A10.5 10.5 0 0 0 1.5 10.5c0 5.8 4.7 10.5 10.5 10.5 2.5 0 4.8-.88 6.6-2.34l-1.39-1.39A8.5 8.5 0 0 1 12 20a8.5 8.5 0 0 1-8.5-8.5c0-3.3 1.9-6.17 4.65-7.63L4.653 3.516zM19.347 3.516L17.84 4.87A8.5 8.5 0 0 1 20.5 12a8.5 8.5 0 0 1-5.18 7.84l1.507 1.354A10.5 10.5 0 0 0 22.5 12c0-3.6-1.8-6.76-4.54-8.62l-1.613 2.136z" />
    <path d="M12 7.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9zm0 7a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z" />
  </svg>
);

export const MenuIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
...
export const MultilingualSupportIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m4 13l4-4M19 17v-2c0-2.209-1.791-4-4-4H5c-1.105 0-2 .895-2 2v6c0 1.105.895 2 2 2h10c2.209 0 4-1.791 4-4v-2z" />
    </svg>
);
...
export const AccessibilityIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        ...
        <path d="M12 12m-3 0a3 3 0 116 0 3 3 0 01-6 0" />
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm6-11a3 3 0 11-6 0 3 3 0 016 0zm-2 7v1a5 5 0 01-10 0v-1a4 4 0 018 0z" />
    </svg>
);
...
export const ThumbsUpIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.97l-2.714 4.072M7 20H4a2 2 0 01-2-2v-6a2 2 0 012-2h3" />
    </svg>
);

export const CursorArrowRaysIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-2.225-2.51-2.225.569 2.225L9.34 14.82l2.423 2.155L13.684 16.6zm-2.51 2.225l.569-2.225-2.51-2.225.569 2.225L9.34 14.82l2.423 2.155L13.684 16.6z M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const MapIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m-6 3l6-3m0 13l-6-3" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.284-2.72-3.741-.479a3 3 0 00-4.682 2.72m.479 3.741A9.094 9.094 0 0018 18.72M12 14c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6z" />
    </svg>
);

export const PuzzlePieceIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5-7.5-7.5 7.5-7.5zM11.25 4.5v15" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.95-.715 2.25-1.15 3.543-1.15a4.5 4.5 0 012.75 1.25" />
    </svg>
);
...
export const RobotIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.125a2.25 2.25 0 002.15 2.824h10.02a2.25 2.25 0 002.15-2.824l-2.41-7.761A2.25 2.25 0 0017.088 3.75H15M4.5 9.75v10.125a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V9.75M8.25 21h7.5" />
  </svg>
);
...
export const SpeakerWaveIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={props.strokeWidth || 2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 7.625V4.5a.75.75 0 00-1.5 0v3.125A9.75 9.75 0 003.75 12c0 5.385 4.365 9.75 9.75 9.75s9.75-4.365 9.75-9.75S18.135 2.25 12.75 2.25zM12.75 7.625a7.5 7.5 0 00-7.5 7.5c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5-3.358-7.5-7.5-7.5z" />
  </svg>
);
