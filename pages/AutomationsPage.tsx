    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold text-dark">Automations</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockAutomations.map(automation => (
                    <div key={automation.id} className="bg-white rounded-lg shadow p-6 flex flex-col">
                        <div className="flex justify-between items-start">
                            <h2 className="text-lg font-bold text-dark flex-1 pr-4">{automation.title}</h2>
                            <label htmlFor={`toggle-${automation.id}`} className="flex items-center cursor-pointer">
                                <div className="relative">
                                    ...
                                    <div className={`block w-12 h-6 rounded-full ${automation.active ? 'bg-primary' : 'bg-gray-300'}`}></div>
                        ...
                        <p className="text-gray-600 text-sm mt-2 flex-grow">{automation.description}</p>
                        <div className="mt-6 border-t pt-4 flex justify-between text-sm">
                            <div className="text-center">
                                <p className="font-bold text-dark">{automation.triggered}</p>
                                <p className="text-gray-500">Triggered</p>
                            </div>
                            <div className="text-center">
                                <p className="font-bold text-dark">{automation.conversion}</p>
