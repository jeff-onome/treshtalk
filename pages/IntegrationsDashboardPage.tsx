    ...
    return (
        <div className="bg-white rounded-lg shadow h-full flex items-center justify-center text-center p-8">
            <div>
                ...
                <h1 className="mt-4 text-2xl font-bold text-dark mb-4">Integrations</h1>
                <p className="text-gray-600">Connect TreshTalk with your favorite apps to streamline your workflow. This feature is coming soon!</p>
            </div>
        </div>
    );
};
